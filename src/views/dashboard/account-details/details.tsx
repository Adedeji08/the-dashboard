    ...
    <div className="flex justify-between gap-10">
      <div className=" bg-white border border-[#fff] mt-10 pt-7 rounded-lg w-full">
        ...
        <Details
          ...
          value={
            account?.socialMediaPlatform || "N/A"
          }
        />
        ...
        <Details
          ...
          value={
            account?.bankAccountNumber || "N/A"
          }
        />

        <Details
          title="Date Joined:"
          value={formatDate(account?.created_at || "N/A")}
        />
        ...
        <div className="flex justify-between px-6 mt-4">
          ...
          >
            {capitalizeFirstLetter(account?.status || "N/A")}
          </p>
        </div>
