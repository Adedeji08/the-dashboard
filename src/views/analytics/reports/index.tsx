      ...
      <div className="bg-white border border-white mt-10 rounded-md w-[88%]">
        <section className="flex justify-between">
          <div className="flex gap-2 px-10 py-6">
            <Icon name="blacklistchart" />
            <p className="text-[14px] font-medium">
            Blacklist <br />
              <span className="text-[10px] font-normal">
              Your blacklist reports for this year  
              </span>
            </p>
          </div>
        ...
        <div className="flex w-full">
          <div className="px-10 py-20 w-1/4">
            ...
            <p className="text-[14px] font-medium">{reportTotal?.total}</p>
  
            <p
              className={`flex gap-3 text-[12px] py-16 ${
                reportTotal?.percentageChange < 0
                  ? "text-[#DD0000]"
                  : "text-[#057517]"
              }`}
            >
